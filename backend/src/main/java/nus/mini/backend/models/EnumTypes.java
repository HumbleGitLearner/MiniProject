...
public class EnumTypes {
    ...
    public enum CatType {
        OUTFOOD, GROCERY, TRANSPORT, EDUCATION, CLOTHING, ENTERTAINMENT, HEALTH, APPLIANCES, OTHERS
    }

    public enum PltfmType {
        GRAB, NTUC, FOODPANDA, DELIVEROO, SHOPEE, LAZADA, AMAZON, QOO10, CAROUSELL
    }

     public enum PmtsType {
        CASH, CREDIT, DEBIT, PAYNOW, PAYLAH, PAYPAL, GOOGLEPAY, APPLEPAY
    }
